...
public class DisplayDendrogram extends JPanel{
	...
	public DisplayDendrogram (TreeDat[] dat, String[] name, SongGroup sg, int dataType, int width, int elespace, int unitSize, Defaults defaults){
		this.sg=sg;
	...
	public DisplayDendrogram (TreeDat[] dat, String[] name, SongGroup sg, int dataType, int width, int elespace, int unitSize, double[] nodeMarkers, Defaults defaults){
		this.sg=sg;
		this.dataType=dataType;
		this.width=width;
		this.elespace=elespace;
