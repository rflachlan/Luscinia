...
public class KMedoids {
	...
	public KMedoids (float[][] dMat, int minK, int maxK, int type, double[] sds, int nsims){
		...
		overallAssignments=new int[maxK-minK+1][n];
		prototypeDistances=new double[maxK+minK+1][n];
		silhouettes=new double[maxK-minK+1][n];
		globalSilhouette=new double[maxK-minK+1];
		simulatedSilhouette=new double[maxK-minK+1];
