...
public class DbConnection {
	...
	public  Song loadSongFromDatabase (int id, int info){
		...
		try {
			...
			if( !rs.next( ) ) {
				...
				song.noiseRemoval=rs.getFloat("noise1");
				song.noiseLength1=rs.getInt("noise2");
				song.noiseLength2=rs.getInt("noise3");
			}
	...
	public void writeSongInfo(Song song){
		...
		String details=s1+"echocomp="+song.echoComp+b+"echorange="+song.echoRange+b+"noise1="+song.noiseRemoval+b+"noise2="+
				song.noiseLength1+b+"noise3="+song.noiseLength2+b+"dyncomp="+song.dynRange+
				b+"dynrange="+song.dynEqual+b+"maxfreq="+song.maxf+b+"framelength="+song.frameLength+b+"timestep="
				+song.timeStep+b+"filtercutoff="+song.frequencyCutOff+b+"windowmethod="+song.windowMethod+b+"dx="+
				song.dx+b+"dy="+song.dy+b+"samplerate="+sa+w+song.songID;
