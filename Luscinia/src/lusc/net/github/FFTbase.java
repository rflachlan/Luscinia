...
public class FFTbase {
	...
	static double[] cosines, sines;
	static int[] bitreverse;
	static int n, nu;
	
	public FFTbase(final int nx, boolean DIRECT){	
		n=nx;
		...
		if (DIRECT)
		    ...
		    constant = 2 * Math.PI;
		makeBitReverseRef(n, nu, constant);
	}
    ...
    private static void makeBitReverseRef(int n, int nu, double constant){
