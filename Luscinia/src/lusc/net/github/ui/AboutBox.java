...
/**
 * Creates a simple box that provides information about Luscinia to the user
*/
 ...
 * Creates a simple box that provides information about Luscinia to the user
 * 
 * @param version The version of Luscinia
 */
    public AboutBox(String version) {
        ...
        aboutLabel[6] = new JLabel("Copyright Robert Lachlan 2007-20");
