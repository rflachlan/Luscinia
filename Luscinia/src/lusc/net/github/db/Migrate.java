...
public class Migrate {
    ...
    private File OLD_H2_FILE = new File("./h2-1.2.127.jar");
   ...
   // public static void main(String... args) throws Exception {
    ...
    public void execute(File file, boolean recursive, String user,
        ...
        File luscloc=new File(getClass().getProtectionDomain().getCodeSource().getLocation().getPath());
        String l2=luscloc.getParent();
        OLD_H2_FILE = new File(l2+File.separator+"h2-1.2.127.jar");
        
        
        this.quiet = runQuiet;
        System.out.println("MIGRATING: "+file.getPath());
